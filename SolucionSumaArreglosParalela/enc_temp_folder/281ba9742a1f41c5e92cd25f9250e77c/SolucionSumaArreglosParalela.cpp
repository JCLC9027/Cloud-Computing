...
int main()
{
    ...
    std::cin >> chunk;
    // Solicitar la cantidad de datos a mostrar al usuario
    int mostrar;
    std::cout << "Ingrese la cantidad  de datos a mostrar: ";
    std::cin >> mostrar;
    ...
    double execution_time = end_time - start_time;  // Calculo de la diferencia
